...
/**
 * Created by dengying on 2018/7/3.
 */
...
/*
        ...
        String ret = ShellUtils.execCommand("getprop dalvik.vm.heapsize", false).successMsg;
        Log.e("dengying", "Shell,isRoot=" + isRoot + ",ret=" + ret);
